...
const CATERING_LOCATION_LINKS = [
  {
    eyebrow: 'Seminyak',
    title: 'Villa catering in Seminyak',
    description: 'A strong route for polished south-Bali dinners, birthday meals, and compact-villa logistics.',
    href: '/seminyak',
  },
  {
    eyebrow: 'Canggu',
    title: 'Group catering in Canggu villas',
    description: 'Useful for surf groups, long stays, and casual shared menus with fast west-coast access.',
    href: '/canggu',
  },
  {
    eyebrow: 'Ubud',
    title: 'Retreat and villa catering in Ubud',
    description: 'Compare this main catering page with our Ubud location coverage for jungle villas and retreats.',
    href: '/ubud',
  },
  {
    eyebrow: 'Booking',
    title: 'Book Bali catering with myCHEF',
    description: 'Move into a quote once you know your date, location, headcount, and preferred service format.',
    href: '/book',
  },
]
  ...
  return (
    <div ref={ref} className="min-h-screen" style={{ background: '#FAFAF8', color: '#1A1A1A' }}>
      ...
      <StrategicLinksSection
        eyebrow="Catering location links"
        title="Jump from Bali catering research to the right area page"
        description="These routes help guests compare our strongest villa regions, see local logistics context, and move directly into a booking once the format is clear."
        cards={CATERING_LOCATION_LINKS}
      />
