...
const PRIVATE_CHEF_DISCOVERY_LINKS = [
  {
    eyebrow: 'Fine Dining',
    title: 'Fine dining in Bali villas',
    description: 'See the broader myCHEF fine-dining experience before deciding on your exact private dinner format.',
    href: '/fine-dining',
  },
  {
    eyebrow: 'Seminyak',
    title: 'Private chef service in Seminyak',
    description: 'Useful if your booking depends on villa access, travel timing, and Seminyak-specific dinner planning.',
    href: '/seminyak',
  },
  {
    eyebrow: 'Groups',
    title: 'Villa catering for larger groups',
    description: 'Compare private chef dinners with broader catering coverage when guest counts or stay length increase.',
    href: '/catering/villa-catering',
  },
  {
    eyebrow: 'Booking',
    title: 'Book a private chef in Bali',
    description: 'Move directly from research into a quote once you know your villa area, date, and guest count.',
    href: '/book',
  },
]
  ...
  return (
    <div ref={ref} className="min-h-screen" style={{ background: '#FAFAF8', color: '#1A1A1A' }}>
      ...
      <StrategicLinksSection
        ...
        title="Keep moving through the private chef journey"
        description="These pages help guests compare fine dining, location-specific planning, and larger-group options before they lock in a Bali chef booking."
        cards={PRIVATE_CHEF_DISCOVERY_LINKS}
      />
