...
- **⚠️ OWNER DECISION — deposit % inconsistency.** Sitewide the deposit is **50%** (Terms, PricingGuide, HubPage, BookPage, pricing FAQ, TrustStrip, cityContent) with 100% upfront only for <24h bookings — consistent. **EXCEPTION: `src/pages/ServiceMixologyPage.tsx` (line ~104) says "25% deposit".** Do not change blindly — confirm the correct figure (almost certainly 50%) and standardize. _(The "25%" on EventsWeddingsPage is a cancellation-refund tier, not the deposit — legitimate.)_
