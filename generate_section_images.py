...
images = [
    {
        "name": "section-villa-kitchen",
        "prompt": "Professional chef cooking in a modern luxury Bali villa kitchen, stainless steel countertops, fresh tropical ingredients, warm natural light, editorial food photography, shallow depth of field, action shot of chef plating"
    },
    {
