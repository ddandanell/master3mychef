      ...
      <SeoHead
        ...
        jsonLd={[
          ...
          faqPageSchema([
            ...
            { question: 'What areas in Bali does myCHEF.id serve?', answer: 'myCHEF.id serves all major Bali areas including Seminyak, Canggu, Ubud, Uluwatu, Sanur, Nusa Dua, and surrounding regions — with 560+ events served and 500+ villa bookings island-wide.' },
            ...
            { question: 'Is myCHEF.id available for same-day bookings in Bali?', answer: 'We require a minimum of 48 hours advance notice. For bookings within 24 hours, 100% payment is required upfront — contact us via WhatsApp at +62 896-7407-2020 to check availability.' },
          ]),
          {
