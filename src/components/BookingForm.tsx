      ...
      <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-5">
        ...
        <div className="p-4 rounded-xl border border-dashed" style={{ borderColor: 'var(--u-border)' }}>
          ...
          <p className="text-sm leading-relaxed" style={{ color: 'var(--u-text-muted)' }}>
            <strong className="text-white/[80%]">50% deposit</strong> confirms your booking and locks your chef. The remaining balance is paid when the chef arrives at your villa, before service begins.
          </p>
        </div>
