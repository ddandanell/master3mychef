...
const CATERING_FAQS = faqPageSchema([
  ...
  { question: 'What is the minimum group size?', answer: 'It depends on the format: 5 for drop-off, 6 for babi guling, 8–10 for villa catering and BBQ, and 30 forbuffets. Tell us your headcount and we\'ll point you to the right service.' },
