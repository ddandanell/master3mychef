...
const CATERING_FAQS = faqPageSchema([
  { question: 'How much does villa catering cost in Bali?', answer: 'Villa catering in Bali starts from IDR 700,000 per person for drop-off catering, IDR 700,000 for buffet, IDR 700,000 for BBQ, and IDR 600,000 per hour for a private villa chef. All prices are transparent — no markup on groceries.' },
