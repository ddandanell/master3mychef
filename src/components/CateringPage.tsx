...
const CATERING_FAQS = faqPageSchema([
  ...
  { question: 'What does "++" mean on your prices?', answer: '"++" means 11% government tax and 10% service charge are added to the listed price. We show all-in totals in every quote so the number you approve is the number you pay.' },
          ...
          <div className="overflow-x-auto bg-white rounded-2xl border border-[#E8E6E3] p-6 mb-6">
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                ...
                <tr className="border-b border-[#E8E6E3]"><td className="py-3 font-medium">Buffet</td><td className="py-3">Weddings, retreats, 30+ groups</td><td className="py-3">30–200+</td><td className="py-3">IDR 475K++/person</td></tr>
