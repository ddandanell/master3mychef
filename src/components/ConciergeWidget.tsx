...
export default function ConciergeWidget() {
  ...
  return (
    <>
      ...
      <div
        ref={popupRef}
        className={`fixed bottom-[calc(1.5rem+3.5rem)] right-5 md:bottom-[calc(2rem+3.5rem)] md:right-8 z-50 w-[320px] max-h-[90vh] overflow-y-auto rounded-2xl bg-[#0A0908] shadow-2xl border border-[#C5A028]/25 border-t-2 border-t-[#C5A028] transition-all duration-200 ${
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4">
          <div className="bg-white/5 rounded-xl p-3 border border-white/5">
            ...
            <p className="text-[10px] text-[#C5A028] mt-2 font-bold uppercase tracking-wider">
            ...
            {SERVICE_OPTIONS.map((option) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-white/90 group-hover:text-white transition-colors">{option.label}</span>
                </button>
              )
            })}
          </div>
          ...
          {/* Benefits */}
          <div className="border-t border-[#C5A028]/15 pt-4 space-y-2 text-[11px] text-white/60 font-medium">
