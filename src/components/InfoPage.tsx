...
export default function InfoPage({ title, description, slug, highlights, heroImage }: InfoPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <SeoHead title={`${title} | myCHEF`} description={description} canonical={canonical} ogImage={heroImage || "/misc-og-image-xl.webp"} jsonLd={[localBusinessSchema, aggregateRatingSchema(4.9, 560), breadcrumbSchema(title, canonical), faqPageSchema([
