...
export default function InfoPage({ title, description, slug, highlights, heroImage }: InfoPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <SeoHead title={`${title} | myCHEF`} description={description} canonical={canonical} ogImage={heroImage || "/mychef-misc-bali-og-image.webp"} jsonLd={[breadcrumbSchema(title, canonical), faqPageSchema([
