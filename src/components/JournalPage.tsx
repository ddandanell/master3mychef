          ...
          {posts.map((post) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-[#4A4745] leading-relaxed flex-1">{post.description}</p>
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <article className="px-6 pt-32 pb-16 max-w-[720px] mx-auto">
        ...
        <p className="text-lg text-[#4A4745] mb-10">{post.description}</p>

        <div className="prose prose-lg max-w-none text-[#4A4745]">
          <p className="italic text-[#8A8784]">Full article coming soon. For immediate help, reach out on WhatsApp.</p>
        </div>
