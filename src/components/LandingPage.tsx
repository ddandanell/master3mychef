  ...
  const landingServiceSchema = (() => {
    ...
    if (entry.slug === 'private-chef-for-events') {
      const schema = serviceWithAggregateOfferSchema({
        ...
        lowPrice: '600000',
        highPrice: '1500000',
        unitText: 'per day chef hire; event menus from IDR 700K–1.2M per person; service staff priced on request. Prices ++ (11% tax + 10% service)',
      })
      schema.provider = {
        '@type': 'Organization',
        name: 'myCHEF',
          ...
          : entry.slug === 'corporate-retreat-catering-bali'
            ...
            : entry.slug === 'michelin-private-chef-bali-prices'
              ...
              : [
                  ...
                  { question: 'What areas in Bali does myCHEF serve?', answer: 'We serve all major Bali areas including Seminyak, Canggu, Ubud, Uluwatu, Sanur, Nusa Dua, Pererenan, and beyond — with 560+ events served and 500+ villa bookings island-wide.' },
                ]
