    ...
    <section className={`py-16 md:py-24 px-6 ${dark ? 'bg-[#0A0A0A]' : 'bg-white'}`}>
      <div className="max-w-[1280px] mx-auto">
        <div className="text-center mb-10 md:mb-14">
          <p
            className={`text-sm tracking-[0.3em] uppercase mb-3 ${dark ? 'text-[#C5A028]' : 'text-[var(--brand-gold-text)]'}`}
            ...
            <Link
              ...
              className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full border text-sm transition-all ${
                dark
                  ...
                  : 'border-[#E8E6E3] text-[#4A4745] hover:border-[var(--brand-gold-text)]/50 hover:text-[var(--brand-gold-text)]'
              }`}
            >
        ...
        <div className="text-center mt-8">
          <Link
            to="/locations"
            className="inline-flex items-center gap-2 text-sm text-[var(--brand-gold-text)] hover:gap-3 transition-all"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
