...
export default function MenuPage() {
    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
        <SeoHead
          ...
          jsonLd={[breadcrumbSchema('Menus', `${SITE}/menus`), faqPageSchema([
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <SeoHead title={`${title} | myCHEF`} description={menu.description} canonical={canonical} ogImage="/hero-fine-dining.webp" jsonLd={[breadcrumbSchema(menu.name, canonical)]} />
