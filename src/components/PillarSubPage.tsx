...
export default function PillarSubPage() {
  ...
  const pillarFaqs: Record<string, { q: string; a: string }[]> = {
    ...
    'catering': [
      ...
      { q: 'Corporate catering?', a: '<a href="/catering/corporate-catering">Corporate catering</a> · <a href="/events/corporate">corporate events</a>.' },
    ...
    'events': [
      ...
      { q: 'Alcohol?', a: 'BYO or sourced at cost with optional bartenders.' },
      ...
      { q: 'Corporate offsites?', a: '<a href="/events/corporate">Corporate events</a>.' },
    ...
    'in-villa-service': [
      ...
      { q: 'Areas covered?', a: 'Island-wide. <a href="/locations">Locations</a>.' },
      { q: 'Combine with private chef?', a: 'Yes — most common luxury setup. <a href="/private-chef-bali">Private chef</a>.' },
    ...
    'staffing': [
      ...
      { q: 'Hotels and restaurants?', a: 'Yes — <a href="/staffing/hotels">hotel staffing</a> and kitchen programmes.' },
      { q: 'Areas covered?', a: 'Island-wide. <a href="/locations">Locations</a>.' },
