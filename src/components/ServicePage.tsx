...
export default function ServicePage() {
  ...
  const serviceFaq = faqPageSchema([
    ...
    },
    {
      ...
      answer: `WhatsApp us at +62 896-7407-2020 with your date, villa location, guest count, and any dietary requirements. We respond within 1 hour and confirm same-day.`,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <SeoHead title={`${title} | myCHEF`} description={service.description} canonical={canonical} ogImage="/mychef-misc-bali-og-image.webp" jsonLd={[serviceSchema, serviceFaq, breadcrumbSchema(service.name, canonical)]} />
