...
export const COCKTAIL_CLUSTER: Record<CocktailClusterSlug, CocktailClusterPage> = {
  bartenders: {
    ...
    cardLabel: 'Luxury cocktail packages',
    role: 'Commercial package page — prices, inclusions, free flow, BYO vs premium',
    inboundAnchor: 'luxury cocktail service packages in Bali',
  },
  mixology: {
    slug: 'mixology',
