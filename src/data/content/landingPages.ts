          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Monthly arrangements use discounted daily rates: from IDR 800,000++ per day for one meal, IDR 1,440,000++ for two meals, or IDR 2,160,000++ for three meals (20% off standard rates). Every booking includes one professional chef and one dedicated assistant; groceries are charged separately at cost, supported by receipts. Prices are subject to 11% government tax + 10% service charge. A full-time live-in chef is a separate employment model, quoted individually by our staffing team."
              }
            },
            {
              "@type": "Question",
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Weekly in-villa chef service starts from IDR 900,000++ per day at the weekly rate (10% off standard). One-off one-meal bookings start from IDR 1,000,000++ with groceries billed at cost. Every booking includes one chef and one dedicated assistant."
              }
            },
            {
              "@type": "Question",
