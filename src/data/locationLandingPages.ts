...
export const LOCATION_LANDING_PAGES: Record<CustomLocationPageSlug, LocationLandingPageConfig> = {
  seminyak: {
    ...
    description: 'Hire a private chef in Seminyak for beachfront villa dinners, BBQs and events. Michelin-trained, fast setup, all Seminyak areas covered. WhatsApp myCHEF.',
  ...
  canggu: {
    ...
    description: 'Hire a private chef in Canggu for villa dinners, poolside BBQs and retreat catering. Ideal for surf groups, families and long stays. WhatsApp myCHEF.',
  ...
  pererenan: {
    ...
    description: 'Hire a private chef in Pererenan for design villa dinners, weekly meal plans and relaxed group feasts. Quiet Canggu enclave. WhatsApp myCHEF today.',
