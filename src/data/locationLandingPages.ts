...
export const LOCATION_LANDING_PAGES: Record<CustomLocationPageSlug, LocationLandingPageConfig> = {
  ...
  canggu: {
    ...
    description: 'Hire a private chef in Canggu for villa dinners, poolside BBQs and retreat catering. Ideal for surf groups, families and long stays. Transparent rates. WhatsApp myCHEF.',
    h1: 'Private Chef Service in Canggu',
    heroImage: '/generated/mychef-city-canggu.webp',
    heroAlt: 'Modern pool villa in Canggu, Bali prepared for a casual private chef BBQ and family dinner',
  ...
  ubud: {
    ...
    description: 'Hire a private chef in Ubud for jungle villa dinners, wellness retreats and multi-day catering. Plant-forward menus, organic sourcing. WhatsApp myCHEF to book.',
  ...
  uluwatu: {
    ...
    description: 'Hire a private chef in Uluwatu for clifftop villa dinners, sunset feasts and wedding catering. Seafood-forward menus with polished service. WhatsApp myCHEF.',
    h1: 'Private Chef Service in Uluwatu',
    heroImage: '/generated/mychef-city-uluwatu.webp',
    heroAlt: 'Clifftop villa terrace in Uluwatu, Bali styled for a premium private chef seafood dinner at sunset',
  ...
  sanur: {
    ...
    description: 'Hire a private chef in Sanur for family villa dinners, beach brunches and events. Calm east-coast service, seafood menus and easy booking. WhatsApp myCHEF.',
  ...
  'nusa-dua': {
    ...
    description: 'Hire a private chef in Nusa Dua for resort villas and executive dinners. Fine dining, plated catering and secure-estate service with transparent rates. WhatsApp myCHEF.',
  ...
  jimbaran: {
    ...
    description: 'Hire a private chef in Jimbaran for seafood villa dinners, bayfront BBQs and sunset events. Fresh local catch with polished villa service. WhatsApp myCHEF.',
  ...
  denpasar: {
    ...
    description: 'Hire a private chef in Denpasar for business lunches, family dinners and private events. Fast central logistics with same-day booking options. WhatsApp myCHEF.',
  ...
  bukit: {
    ...
    description: 'Hire a private chef on the Bukit Peninsula for clifftop villa dinners, surf-group feasts and celebrations. Uluwatu, Pecatu and Ungasan covered. WhatsApp myCHEF.',
  ...
  pererenan: {
    ...
    description: 'Hire a private chef in Pererenan for design villa dinners, weekly meal plans and relaxed group feasts. Quiet Canggu enclave with transparent rates. WhatsApp myCHEF.',
    h1: 'Private Chef Service in Pererenan',
    heroImage: '/generated/mychef-city-pererenan.webp',
    heroAlt: 'Design-led villa in Pererenan, Bali styled for an intimate private chef dinner at dusk',
