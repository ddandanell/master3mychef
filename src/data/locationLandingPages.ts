...
export const LOCATION_LANDING_PAGES: Record<CustomLocationPageSlug, LocationLandingPageConfig> = {
  ...
  uluwatu: {
    ...
    description: 'Hire a private chef in Uluwatu for clifftop villa dinners, sunset feasts and wedding catering. Seafood-forward menus, polished service. WhatsApp myCHEF.',
  ...
  'nusa-dua': {
    ...
    description: 'Hire a private chef in Nusa Dua for resort villas and executive dinners. Fine dining, plated catering and secure-estate service. WhatsApp myCHEF today.',
  ...
  jimbaran: {
    ...
    description: 'Hire a private chef in Jimbaran for seafood villa dinners, bayfront BBQs and sunset events. Fresh local catch, polished service. WhatsApp myCHEF today.',
  ...
  denpasar: {
    ...
    description: 'Hire a private chef in Denpasar for business lunches, family dinners and private events. Fast central logistics, same-day booking. WhatsApp myCHEF.',
