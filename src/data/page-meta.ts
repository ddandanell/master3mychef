...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  'bar-services-hub': {
    ...
    title: 'Cooking Class Bali | Private In-Villa, Chef Comes to You',
    description:
      'Private cooking class Bali in your villa. Chef comes to you — 2.5 or 3 hours, 4–6 dishes, eat everything, diploma. From IDR 700,000++/person, min 4. Book with two days’ notice.',
