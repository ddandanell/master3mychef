...
export const REDIRECTS: Redirect[] = [
  ...
  { from: '/private-chef', to: '/', reason: 'Live 404: bare /private-chef → homepage, which owns the head term private chef bali. Exact path only — does not 301 /private-chef-bali or /private-chef/[area].' },
