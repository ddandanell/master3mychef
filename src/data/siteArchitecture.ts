...
export const PILLARS: Record<PillarSlug, Pillar> = {
  ...
  'in-villa-service': {
    ...
    description: 'Uniformed villa staff in Bali — waiters, butlers, sommeliers and hosts (priced on request); complete cocktail service packages from IDR 500,000++ per guest.',
...
export const LOCATIONS: Record<LocationSlug, LocationPage> = {
  ...
  kuta: {
    ...
    description: 'Hire a private chef in Kuta Bali for villa dinners, BBQ parties, and celebrations. myCHEF serves Kuta, Legian, and Tuban. Stay chef from IDR 2.7M++/day.',
