...
export const PILLARS: Record<PillarSlug, Pillar> = {
  'fine-dining': {
    ...
    subPages: [
      { slug: 'romantic-dinner', label: 'Romantic Dinner', h1: 'Romantic Private Dinner in Your Bali Villa with a Private Chef', title: 'Private Chef Romantic Dinner Bali | 7 & 9 Course Villa | myCHEF', description: 'Private chef romantic dinner in your Bali villa. 7- & 9-course tasting, Indonesian or Western, candlelit styling. From IDR 3.8M++ pp. WhatsApp quote.' },
