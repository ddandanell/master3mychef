...
export const PILLARS: Record<PillarSlug, Pillar> = {
  ...
  catering: {
    ...
    subPages: [
      ...
      { slug: 'buffet', label: 'Buffet Catering', h1: 'Buffet Catering Bali for Weddings, Retreats & Large Groups', title: 'Buffet Catering Bali | Large Group & Event Buffets | myCHEF', description: 'Buffet catering in Bali for weddings, corporate retreats & large villa parties — full setup, service & cleanup included. WhatsApp myCHEF.' },
      { slug: 'plated-catering', label: 'Plated Dinner Catering', h1: 'Plated Dinner Catering Bali — Formal Multi-Course Service at Your Villa', title: 'Plated Catering Bali | Formal Villa Dinner Service | myCHEF', description: 'Plated dinner catering in Bali: formal 3–5 course table service at your villa, from IDR 800K++/person with chef, waiters & full styling. WhatsApp myCHEF.' },
      { slug: 'drop-off-catering', label: 'Drop-Off Catering', h1: 'Drop-Off Catering Bali — Chef-Prepared Dinners, Delivered. No Staff, No Fuss.', title: 'Drop-Off Catering Bali | Chef Food Delivered to Your Villa', description: 'Drop-off catering in Bali: premium chef-prepared food delivered to your villa, ready to serve. From per-person pricing. WhatsApp myCHEF.' },
      ...
      { slug: 'grazing-tables', label: 'Grazing Tables', h1: 'Grazing Tables Bali — Styled Spreads for Events, Weddings & Villas', title: 'Grazing Table Bali | Styled Event Platters & Spreads', description: 'Grazing tables in Bali: artisan cheese, charcuterie & fresh fruit spreads styled for welcome drinks, weddings & poolside events. WhatsApp myCHEF.' },
      { slug: 'villa-catering', label: 'Villa Catering', h1: 'Villa Catering Bali — Multi-Day Meal Plans & Group Stays', title: 'Villa Catering Bali | Multi-Day Meal Plans for Groups', description: 'In-villa catering for multi-day Bali stays: breakfast, lunch & dinner plans for families and groups of 8–200. From IDR 450K++/person. WhatsApp myCHEF.' },
      { slug: 'corporate-catering', label: 'Corporate Catering', h1: 'Corporate Catering Bali — The Catering Line for Teams, Meetings & Conferences', title: 'Corporate Catering Bali | Boardroom to Conference | myCHEF', description: 'Corporate catering in Bali for offsites, boardroom dinners & conferences. Tax invoices (NPWP), executive service, dietary-exact menus. WhatsApp myCHEF.' },
      { slug: 'retreat-catering', label: 'Retreat Catering', h1: 'Retreat Catering Bali — Per-Day Meal Plans for Multi-Day Retreats', title: 'Retreat Catering Bali | Per-Day Meal Plans | myCHEF', description: 'Retreat catering in Bali: plant-forward, nutrient-dense meal plans for multi-day retreats. Vegan, raw & gluten-free specialists. WhatsApp myCHEF.' },
      { slug: 'floating-breakfast', label: 'Floating Breakfast', h1: 'Floating Breakfast in Bali — Chef-Prepared, Served in Your Villa Pool', title: 'Floating Breakfast Bali | Chef-Prepared, Island-Wide', description: 'Floating breakfast in your Bali villa pool — chef-prepared and styled, delivered island-wide incl. Ubud, Uluwatu & Nusa Dua. WhatsApp myCHEF.' },
    ],
  },
  events: {
    slug: 'events',
