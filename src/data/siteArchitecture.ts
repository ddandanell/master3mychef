...
export const PILLARS: Record<PillarSlug, Pillar> = {
  ...
  'in-villa-service': {
    ...
    subPages: [
      ...
      { slug: 'bartenders', label: 'Bartenders', h1: 'Luxury Cocktail & Bartender Service in Bali', title: 'Luxury Cocktail & Bartender Service Bali | myCHEF', description: 'Complete villa cocktail service from IDR 500K++ per guest — BYO, free flow or premium packages. WhatsApp myCHEF.' },
      { slug: 'mixology', label: 'Mixology', h1: 'Private Mixology Experiences and Custom Cocktails in Bali', title: 'Private Mixology Bali | Custom Cocktails | myCHEF', description: 'Private mixology in Bali: custom menus, Bali signatures and interactive craft. Full cocktail packages from IDR 500K++/guest.' },
...
export const LOCATIONS: Record<LocationSlug, LocationPage> = {
  ...
  kuta: {
    ...
    description: 'Hire a private chef in Kuta Bali for villa dinners, BBQ parties, and celebrations. myCHEF serves Kuta, Legian, and Tuban from IDR 1M++/day.',
