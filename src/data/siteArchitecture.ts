...
export const PILLARS: Record<PillarSlug, Pillar> = {
  ...
  catering: {
    ...
    description: 'Premium catering across Bali for private villas, weddings, corporate events, retreats and celebrations. Chef-led hospitality, full setup and tailored menus by myCHEF.',
    title: 'Catering Bali | Premium Villa, Wedding & Corporate Catering | myCHEF',
    intro: 'Premium catering across Bali for private villas, weddings, corporate events, retreats and celebrations. BBQs, buffets, plated dinners, drop-off feasts, and chef-led hospitality with full setup and cleanup.',
    navLabel: 'Catering',
