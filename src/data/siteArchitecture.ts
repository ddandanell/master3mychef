...
export const PILLARS: Record<PillarSlug, Pillar> = {
  ...
  staffing: {
    ...
    subPages: [
      ...
      { slug: 'household-management', label: 'Household Management', h1: 'Professional Household Managers', title: 'Hire Household Manager Bali | Estate Operations — myCHEF', description: 'Experienced managers to oversee large residences, staff scheduling, maintenance, and vendor relationships.' },
      ...
      { slug: 'for-hotels', label: 'For Hotels', h1: 'Hotel Culinary Staffing Support', title: 'Hotel Staffing Bali | Kitchen & Service Support — myCHEF', description: 'Temporary or permanent culinary staffing solutions for Bali hotels and restaurants. Vetted, high-standard professionals.' },
    ],
  },
}
