...
export function buildSitemap(): SitemapEntry[] {
  ...
  const barServicesPages: SitemapEntry[] = [
    ...
    {
      path: PAGE_META['experience-whiskey-cigar-experience'].path,
      type: 'service',
      title: PAGE_META['experience-whiskey-cigar-experience'].title,
      description: PAGE_META['experience-whiskey-cigar-experience'].description,
      priority: 0.85,
      changefreq: 'monthly',
    },
    {
  ...
  const infoPages: SitemapEntry[] = [
    ...
    // Wedding cost education owner (was wrongly 301 → packages). Live PremiumPage.
    metaInfo('blog-bali-wedding-catering-budget-guide', 'blog-post', 0.8, 'monthly', '2026-08-07'),
