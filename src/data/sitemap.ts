...
export function buildSitemap(): SitemapEntry[] {
  ...
  const barServicesPages: SitemapEntry[] = [
    ...
    },
    {
      ...
      type: 'service',
      title: 'Private Cocktail Party Bali | Chef & Bartender in Your Villa | myCHEF',
    ...
    },
    {
      ...
      type: 'service',
      title: 'Sushi Masterclass Bali | Private Villa Sushi Making Class | myCHEF',
      description: 'Book a private sushi-making class at your Bali villa. Learn maki, nigiri and hand rolls with a sushi chef. Fresh ingredients and equipment included.',
      priority: 0.8,
      changefreq: 'monthly',
    },
    {
      ...
      description: 'Book a private cooking class at your Bali villa. Choose Italian, Indonesian, Japanese, French, healthy or kids’ cooking. Ingredients included.',
      priority: 0.8,
      changefreq: 'monthly',
    },
    {
      ...
      type: 'service',
      title: 'Kids Birthday Party Bali | Cooking and Pizza Party | myCHEF',
      description: 'Plan a kids’ cooking birthday party at your Bali villa with pizza making, cupcakes, sushi, mocktails, chef hats, entertainment and cleanup.',
      priority: 0.8,
      changefreq: 'monthly',
    },
    {
      ...
      type: 'service',
      title: 'Oyster Bar Bali | Champagne and Oyster Experience | myCHEF',
      description: 'Book a private oyster bar and champagne reception at your Bali villa, wedding or event. Fresh oysters, service staff and premium upgrades available.',
      priority: 0.8,
      changefreq: 'monthly',
    },
    {
      ...
      type: 'service',
      title: 'Proposal Package Bali | Private Villa Proposal Dinner | myCHEF',
      description: 'Plan a private proposal in Bali with dinner, flowers, candles, styling, photographer, musician and complete coordination. Request a confidential quote.',
      priority: 0.8,
      changefreq: 'monthly',
    },
    ...BAR_SERVICES.map((s) => ({
  ...
  const infoPages: SitemapEntry[] = [
    ...
    { path: '/catering', type: 'info', title: 'Catering Bali | Premium Villa, Wedding & Corporate Catering | myCHEF', description: 'Premium catering across Bali for private villas, weddings, corporate events, retreats and celebrations. Chef-led hospitality, full setup and tailored menus by myCHEF.', priority: 0.9, changefreq: 'weekly' },
    ...
    { path: '/reviews', type: 'info', title: 'myCHEF Bali Reviews | Private Chef & Catering Feedback', description: 'Read guest reviews from myCHEF Bali villa dinners, weddings, retreats & events. Real hosts, real outcomes — see why 560+ villas keep coming back.', priority: 0.7, changefreq: 'monthly' },
