...
export function buildSitemap(): SitemapEntry[] {
  ...
  const infoPages: SitemapEntry[] = [
    ...
    { path: '/families', type: 'info', title: 'Browse Menu Families — Find Your Perfect Menu | myCHEF.id', description: 'Browse myCHEF.id menus by family. 50 menus across 6 collections. Find your perfect dining experience.', priority: 0.8, changefreq: 'weekly' },
    ...
    { path: '/blog/drop-off-catering-bali', type: 'blog-post', title: 'Drop-Off Catering Bali -- Fresh Villa Food Delivered Ready to Serve', description: 'Drop-off catering in Bali for villa stays. Fresh food prepared professionally and delivered ready to serve. From IDR 150K/person. All areas covered.', priority: 0.8, changefreq: 'monthly', date: '2026-06-30' },
    ...
    { path: '/blog/indonesian-street-food-private-chef-bali', type: 'blog-post', title: 'Indonesian Street Food at Your Bali Villa -- Private Chef', description: 'Authentic Indonesian street food classics at your Bali villa -- nasi goreng, satay lilit, babi guling, gado-gado -- by a private chef. From IDR 350K/person.', priority: 0.8, changefreq: 'monthly', date: '2026-06-30' },
  ]
