...
export function buildSitemap(): SitemapEntry[] {
  ...
  const infoPages: SitemapEntry[] = [
    ...
    { path: '/fine-dining', type: 'info', title: 'Private Fine Dining Bali — Book a Michelin-Trained Chef | myCHEF', description: '24 premium set menus for private villa dining in Bali. Vegetarian, seafood, mixed meats & single-meat. From IDR 1.25M per guest. Book your chef.', priority: 0.9, changefreq: 'weekly' },
    { path: '/catering', type: 'info', title: 'Villa Catering Bali | BBQ, Buffet, Plated & Babi Guling — myCHEF', description: 'Full-service catering for Bali villas. BBQ nights, buffets, drop-off feasts, and grazing tables for groups of 10 to 150.', priority: 0.9, changefreq: 'weekly' },
    { path: '/events', type: 'info', title: 'Private Events Bali | Weddings, Corporate & Villa Parties — myCHEF', description: 'One team for your entire event. Weddings, birthdays, corporate retreats, and villa parties anywhere in Bali.', priority: 0.9, changefreq: 'weekly' },
    { path: '/in-villa-service', type: 'info', title: 'Villa Service Bali | Waiters, Butlers & Bartenders — myCHEF', description: 'Uniformed, English-speaking staff for your villa. Waiters, butlers, bartenders, and coordinators available by the shift.', priority: 0.8, changefreq: 'monthly' },
    ...
    // /calculator is a noindex conversion utility — excluded from sitemap.
    ...
    { path: '/locations', type: 'info', title: 'Private Chef Bali | Seminyak, Canggu, Ubud & Uluwatu — myCHEF', description: 'Hire a private chef across Bali — Seminyak, Canggu, Ubud, Uluwatu, and beyond.', priority: 0.8, changefreq: 'monthly' },
    ...
    { path: '/staffing', type: 'info', title: 'Chef Staffing Bali | Villas, Hotels & Homes — myCHEF', description: 'Long-term private chef placement, villa staff, and hospitality recruitment in Bali and Jakarta.', priority: 0.8, changefreq: 'monthly' },
