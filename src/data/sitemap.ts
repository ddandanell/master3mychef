...
export function buildSitemap(): SitemapEntry[] {
  ...
  const infoPages: SitemapEntry[] = [
    ...
    // Conversion & utility pages — /book and /quote intentionally excluded (noindex)
    ...
    { path: '/chefs/adriano', type: 'info', title: 'Adriano — Private Chef Bali | Michelin-Trained Founder | myCHEF', description: 'Book Adriano, Executive Chef & Founder of myCHEF Bali. Michelin-trained in Milan. Italian tasting menus, romantic dinners and VIP villa experiences.', priority: 0.7, changefreq: 'monthly' },
