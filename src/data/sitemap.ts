...
export function buildSitemap(): SitemapEntry[] {
  ...
  const infoPages: SitemapEntry[] = [
    ...
    // Conversion & utility pages — /book intentionally excluded (noindex tag)
    { path: '/quote', type: 'info', title: 'Get a Custom Quote | Private Chef & Catering Bali — myCHEF', description: 'Get a fast, itemised quote for private chef, villa catering, or event staffing in Bali. Tell us your occasion, guests, and location — we reply within 24 hours.', priority: 0.7, changefreq: 'monthly' },
