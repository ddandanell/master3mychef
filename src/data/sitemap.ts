...
export const INFO_PAGES: SitemapEntry[] = [
  { path: '/about', type: 'info', title: 'About myCHEF', description: 'About myCHEF — our story, our team, and our mission to bring extraordinary food to villas across Indonesia.', priority: 0.8, changefreq: 'monthly' },
  { path: '/chefs', type: 'info', title: 'Our Chefs', description: 'Meet our team of professional private chefs — backgrounds, specialties, and what they cook best.', priority: 0.8, changefreq: 'monthly' },
  { path: '/faq', type: 'info', title: 'Frequently Asked Questions', description: 'Answers to common questions about private chef services in Bali — bookings, pricing, dietary needs, and logistics.', priority: 0.8, changefreq: 'monthly' },
  { path: '/why-mychef', type: 'info', title: 'Why Choose myCHEF', description: 'Why myCHEF is the most-trusted private chef service in Bali — vetted chefs, transparent pricing, and same-day response.', priority: 0.8, changefreq: 'monthly' },
  { path: '/reviews', type: 'info', title: 'Reviews', description: 'Real reviews from real guests — read what families, couples, and event hosts say about myCHEF.', priority: 0.8, changefreq: 'monthly' },
  { path: '/pricing', type: 'info', title: 'Pricing', description: 'Transparent pricing for private chef services in Bali — hourly rates, menu pricing, and event packages.', priority: 0.8, changefreq: 'monthly' },
  { path: '/villa-partners', type: 'info', title: 'Villa Partner Programme', description: 'Partner with myCHEF — preferred pricing, dedicated account management, and quality control for villa rentals.', priority: 0.7, changefreq: 'monthly', aliases: ['/partners'] },
  { path: '/jakarta', type: 'area', title: 'Private Chef in Jakarta', description: 'Private chef services in Jakarta — for residences, expat households, and corporate hospitality.', priority: 0.8, changefreq: 'weekly', area: 'Jakarta' },
  { path: '/retreats', type: 'info', title: 'Retreat Catering in Bali', description: 'Multi-day catering for yoga retreats, wellness retreats, and corporate offsites across Bali.', priority: 0.8, changefreq: 'monthly' },
  { path: '/catering', type: 'info', title: 'Catering Services in Bali', description: 'Full-service catering in Bali — villa parties, weddings, corporate events, and multi-day stays.', priority: 0.8, changefreq: 'monthly', aliases: ['/villa-chef'] },
