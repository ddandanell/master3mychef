        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-28">
            {PACKAGES.map((pkg, i) => (
              ...
              >
                <a
                  href={`https://wa.me/628113803488?text=${encodeURIComponent('Hi myCHEF — interested in the ' + pkg.name + ' package. Could you send details?')}`}
                  target="_blank"
          ...
          <div className="text-center mt-20">
            ...
            <a
              href="https://wa.me/628113803488?text=Hi%20myCHEF%20%E2%80%94%20I%27d%20like%20to%20design%20a%20custom%20villa%20party"
              target="_blank"
              rel="noopener noreferrer"
