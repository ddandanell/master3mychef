        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-28">
            {PACKAGES.map((pkg, i) => (
              ...
              >
                <a
                  href={`https://wa.me/62089674072020?text=${encodeURIComponent('Hi myCHEF — interested in the ' + pkg.name + ' package. Could you send details?')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  data-source="aura-package-image-cta"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  data-source="aura-package-text-cta"
          ...
          <div className="text-center mt-20">
            ...
            <a
              href="https://wa.me/62089674072020?text=Hi%20myCHEF%20%E2%80%94%20I%27d%20like%20to%20design%20a%20custom%20villa%20party"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="py-24 md:py-32 px-6" style={{ background: '#0F0F0F' }}>
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="aura-final-cta" className="inline-flex items-center gap-2 px-8 py-4 bg-[#2C5F7C] text-white text-sm font-semibold tracking-widest uppercase rounded-full hover:bg-[#1e4a63] transition-all focus:outline-none focus:ring-2 focus:ring-white rounded px-0.5">
              <MessageCircle className="w-4 h-4" /> Get Quote in 24h — Free Consultation
            </a>
            <a href="tel:+62089674072020" className="inline-flex items-center gap-2 px-8 py-4 border border-white/30 text-white text-sm tracking-widest uppercase rounded-full hover:bg-white/10 transition-all focus:outline-none focus:ring-2 focus:ring-white rounded px-0.5">
