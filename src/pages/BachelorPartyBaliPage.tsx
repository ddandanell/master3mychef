...
const FAQS = [
  {
    question: 'How many guests can you cater for at a bachelor party?',
    answer: 'We comfortably cater for 8–40 guests at bachelor parties. Larger groups are possible — contact us directly to discuss logistics and pricing for groups above 40.',
  },
  {
    question: 'Can you provide alcohol and drinks as well?',
    answer: 'We provide the chef, service staff, bar setup, and bartender (if booked as an add-on). Alcohol is client-supplied — we advise on quantities and can recommend local suppliers. The bartender add-on covers all mixing and service once you have the bottles.',
  },
  {
    question: 'What\'s the difference between the BBQ Night and the Feast package?',
    answer: 'The BBQ Night is casual and informal — standing, sharing plates, grill-side service, maximum social energy. The Feast package is a seated experience with coursed service and a cocktail welcome. BBQ Night suits groups who want to be on their feet; Feast suits groups who want the party to begin with a proper sit-down dinner.',
  },
  {
    question: 'Do you do late-night service?',
    answer: 'Yes. We offer a midnight snack drop add-on (IDR 200,000/person) for groups staying up late. The chef prepares the tray and delivers it at the arranged time — sliders, fried snacks, cheese, and fresh items. Service can be extended past midnight with advance notice.',
  },
  {
    question: 'How far in advance should we book?',
    answer: '1 week minimum for most dates. For peak periods — July, August, and December — we recommend booking 2–3 weeks ahead. Same-week bookings are sometimes possible depending on chef availability; message us to check.',
  },
  {
...
const RELATED_PAGES = [
  { label: 'Bachelorette Party Bali', href: '/blog/bachelorette-party-bali-catering', desc: 'Hen\'s night catering and private chef packages for Bali villas.' },
