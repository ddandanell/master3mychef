...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    <p><strong>Event booking (single or multi-session):</strong> You book a chef for a specific occasion — a dinner, a villa week, a series of meals during a stay. The chef comes, cooks the engagement, and leaves. There is no ongoing employment relationship. Pricing is per event. This is the model for most holiday villa bookings and corporate event catering. See our guide on <a href="/blog/private-chef-roles-responsibilities-explained" class="text-[#C5A028] hover:underline font-medium">what a private chef does</a> for this format.</p>
  ...
  },
  {
    ...
    <p><strong>Live-in household chef:</strong> A chef who resides at the villa or property and is available for all household meals on a daily basis. Full-time, live-in role. See our <a href="/blog/live-in-chef-bali-hiring-guide" class="text-[#C5A028] hover:underline font-medium">live-in chef guide</a> for detailed scope and contract terms.</p>
