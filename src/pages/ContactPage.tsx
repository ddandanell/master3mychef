...
const FAQS = [
  { q: 'How do I contact myCHEF?', a: 'The fastest way is WhatsApp at +62089674072020. You can also email indonesia@mychef.id or call the same number. We usually reply within minutes on WhatsApp.' },
  ...
  { q: 'Can I call instead of using WhatsApp?', a: 'Yes. You can call +62089674072020 directly. Our lines are open daily from 08:00 to 22:00 WITA.' },
    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <section className="bg-white px-6 md:px-12 py-16 md:py-20 border-y border-[#E5E3E0]">
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <ContactItem icon={MessageCircle} label="WhatsApp" value="+62089674072020" href={`https://wa.me/${WA}`} hint="Fastest — typically within minutes" dataSource="contact-info-whatsapp" />
          <ContactItem icon={Mail} label="Email" value="indonesia@mychef.id" href="mailto:indonesia@mychef.id" hint="For detailed proposals" />
          <ContactItem icon={Phone} label="Phone" value="+62089674072020" href="tel:+62089674072020" hint="08:00 – 22:00 WITA, daily" />
