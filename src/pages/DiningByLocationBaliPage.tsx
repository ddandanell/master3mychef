...
const SECTIONS = [
  ...
  },
  {
    ...
    body: `<p><strong>Character:</strong> Upscale, cosmopolitan beach resort — fine-dining restaurants on every corner, luxury villas with pools and ocean views, international traveler profile. Bali's most developed tourist area.</p>
    <p><strong>Private Chef Advantage:</strong> Escape crowded restaurants while staying in the sophisticated hub. Oceanfront or poolside dining without reservation hassles. A private chef delivers restaurant-quality cuisine in a setting restaurants can't replicate.</p>
  ...
  },
  {
    ...
    body: `<p><strong>Character:</strong> Trendy, creative hub — digital nomads, yoga practitioners, surf culture, cafés with pour-over coffee, design-forward boutique villas. Younger, more health-conscious crowd than Seminyak.</p>
  ...
  },
  {
    ...
    body: `<p><strong>Character:</strong> Clifftop location with dramatic Indian Ocean and sunset views. Quieter, more exclusive than beach areas. Spacious luxury villas with infinity pools and gardens. The most photogenic location in Bali for dining.</p>
    <p><strong>Private Chef Advantage:</strong> Host world-class dinners in a natural amphitheater setting. The backdrop does half the work — a skilled chef with quality ingredients creates an experience no restaurant can match. Highly exclusive, completely private.</p>
  ...
  },
  {
    ...
    body: `<p><strong>Character:</strong> Spiritual, artistic, agrarian heart of Bali. Rice paddies, traditional culture, yoga retreats, temples, healers. Villas immersed in nature — often rustic-luxury, smaller than coastal areas. The most authentically Balinese experience for guests.</p>
    <p><strong>Private Chef Advantage:</strong> Celebrate Balinese cuisine authentically with chefs who have direct relationships with local farmers. Access to farm-fresh ingredients picked the same morning. Retreat catering with nutritional and cultural focus.</p>
  ...
  },
  {
    ...
    body: `<p><strong>Sanur Character:</strong> Quiet, local beach community. Fishing villages, relaxed pace, fewer tourists than Seminyak. Families and long-term residents. Villas: mid-range, casual, beach-adjacent.</p>
    ...
    <p><strong>Jimbaran Character:</strong> Beach fishing village famous for sunset seafood culture. Mix of local and tourist. Villas: mid-range, beach-adjacent, casual.</p>
