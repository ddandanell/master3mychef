...
const SECTIONS: PageSection[] = [
  {
    ...
    imageAlt: 'Children enjoying an interactive kids birthday chef party at a Bali villa',
...
export default function ExperienceKidsBirthdayChefPartyPage() {
  return (
    <PremiumPage
      ...
      heroImageAlt="Children enjoying an interactive kids birthday chef party at a Bali villa"
