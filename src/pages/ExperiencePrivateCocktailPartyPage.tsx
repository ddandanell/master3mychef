...
const SECTIONS: PageSection[] = [
  {
    ...
    title: 'Host a Private Cocktail Party in Bali with a Personal Chef & Bar Team',
    image: '/generated/mychef-mixology-bali-cocktail-craft.webp',
    imageAlt: 'Bartender crafting a signature cocktail at a private Bali cocktail party',
    body: `<p>A private cocktail party in Bali is one of the most effortless ways to bring people together. Whether you are celebrating a birthday, an anniversary, a villa welcome, a corporate retreat, or simply a night worth remembering, the right cocktail party turns a beautiful villa into the only venue that matters. There is no queue at the bar, no fixed closing time, and no generic drinks list — just your guests, your setting, and a team that builds the evening around you.</p>
  ...
  },
  {
    ...
    type: 'content' as const,
    subtitle: 'Investment',
    title: 'Private Cocktail Party Pricing',
    image: '/generated/mychef-mixology-bali-bar-setup.webp',
    imageAlt: 'Professional mobile bar setup for a private cocktail party in Bali',
    body: `<p>Pricing for a private cocktail party depends on guest count, menu complexity, bar package, service duration, and staffing requirements. Because every event is tailored, we quote each party individually after a brief planning call.</p>
    ...
    <p><strong>Starting from: [PRICE REQUIRES CONFIRMATION]</strong></p>
  ...
  },
  {
    ...
    primaryAction: {
      ...
      href: 'https://wa.me/6289674072020?text=Hi%20myCHEF%2C%20I%27m%20interested%20in%20hosting%20a%20private%20cocktail%20party%20in%20Bali%20and%20would%20love%20to%20discuss%20options.',
      external: true,
    },
    secondaryAction: {
      label: 'View Pricing',
...
const FAQS = [
  ...
  { question: 'How far in advance should I book a private cocktail party?', answer: 'We recommend booking at least 2–3 weeks in advance. During peak season (July–August and December), 4–6 weeks is safer. Last-minute requests may be possible depending on availability.' },
...
const RELATED_PAGES = [
  ...
  { label: 'Mixology Class', href: '/experiences/mixology-class', desc: 'Learn cocktail craft from professional bartenders in your villa.' },
  { label: 'Uluwatu Private Chef', href: '/private-chef/uluwatu', desc: 'Private chef and cocktail parties for Uluwatu clifftop villas.' },
  { label: 'Seminyak Private Chef', href: '/private-chef/seminyak', desc: 'Private chef and cocktail parties for Seminyak villas and estates.' },
]
...
export default function ExperiencePrivateCocktailPartyPage() {
  return (
    <PremiumPage
      ...
      title="Private Cocktail Party Bali: Chef & Bartender in Your Villa"
      description="Host a private cocktail party in Bali with a personal chef, bartender, and canapés. Custom cocktails, full bar setup, villa service. Message us on WhatsApp."
      seoTitle="Private Cocktail Party Bali | Chef & Bartender in Your Villa | myCHEF"
      seoDescription="Host a private cocktail party in Bali with a personal chef, bartender, and canapés. Custom cocktails, full bar setup, villa service. Message us on WhatsApp."
      canonicalUrl="https://mychef.id/experiences/private-cocktail-party"
      h1="Private Cocktail Party Bali"
      subtitle="A Personal Chef, Bartender & Bar Experience in Your Villa"
      heroImage="/generated/mychef-events-bali-villa-party-night.webp"
      heroImageAlt="Guests enjoying a private cocktail party at a Bali villa at night"
      ogImage="https://mychef.id/generated/mychef-events-bali-villa-party-night.webp"
      keywords={[
      ...
      extraJsonLd={[
        breadcrumbSchema(
          'Private Cocktail Party Bali',
          'https://mychef.id/experiences/private-cocktail-party',
          'Experiences',
        ...
        faqPageSchema(FAQS),
        {
          ...
          '@type': 'Service',
          name: 'Private Cocktail Party Bali — Personal Chef & Bartender',
          description:
            'Host a private cocktail party in Bali with a personal chef, bartender, custom cocktails, canapés, and full bar setup in your villa.',
          ...
          offers: {
            ...
            description: 'Pricing quoted individually based on guest count, menu, and bar package',
          },
        },
      ]}
