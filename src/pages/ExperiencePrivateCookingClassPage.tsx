...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    title: 'Every Private Cooking Class Includes',
    features: [
      {
        icon: GraduationCap,
  ...
  },
  {
    ...
    type: 'content' as const,
    subtitle: 'Investment',
    title: 'Private Cooking Class Pricing',
  ...
  },
  {
    ...
    primaryAction: {
      ...
      href: 'https://wa.me/6289674072020?text=Hi%20myCHEF%2C%20I%27m%20interested%20in%20a%20private%20cooking%20class%20at%20my%20Bali%20villa.%20Can%20you%20help%20me%3F',
      external: true,
    },
    secondaryAction: {
      label: 'View Pricing',
...
const RELATED_PAGES = [
  ...
  { label: 'Honeymoon Chef Bali', href: '/honeymoon-chef', desc: 'Private chef experiences designed for honeymoon couples.' },
  ...
  { label: 'In-Villa Service', href: '/in-villa-service', desc: 'Waiters, butlers, bartenders and villa staffing for your stay.' },
...
export default function ExperiencePrivateCookingClassPage() {
  return (
    <PremiumPage
      slug="experience/private-cooking-class"
      title="Private Cooking Class Bali"
      ...
      seoTitle="Private Cooking Class Bali | Learn at Your Villa | myCHEF"
      ...
      canonicalUrl="https://mychef.id/experience/private-cooking-class"
      h1="Private Cooking Class Bali"
      subtitle="Learn Balinese & Indonesian Cuisine with a Private Chef at Your Villa"
      heroImage="/generated/mychef-experience-bali-luna-hero-v4.webp"
      heroImageAlt="Private chef teaching Balinese cooking at a luxury Bali villa"
      ogImage="https://mychef.id/generated/mychef-experience-bali-luna-hero-v4.webp"
      keywords={[
      ...
      extraJsonLd={[
        breadcrumbSchema(
          'Private Cooking Class Bali',
          'https://mychef.id/experience/private-cooking-class',
          'Experience',
        ...
        faqPageSchema(FAQS.map((f) => ({ question: f.question, answer: f.answer }))),
        {
          ...
          url: 'https://mychef.id/experience/private-cooking-class',
          image: 'https://mychef.id/generated/mychef-experience-bali-luna-hero-v4.webp',
          offers: {
            '@type': 'Offer',
            priceCurrency: 'IDR',
            price: '700000',
