...
const EXPERIENCES = [
  {
    ...
    linkText: 'private cocktail party at your villa',
    icon: Wine,
  ...
  },
  {
    ...
    linkText: 'private sushi masterclass',
  ...
  },
  {
    ...
    price: 'From IDR 700K per person ++',
    linkText: 'private cooking class in your villa',
    icon: ChefHat,
  ...
  },
  {
    ...
    linkText: 'kids birthday chef party',
    icon: PartyPopper,
  ...
  },
  {
    ...
    linkText: 'full proposal package',
    icon: Heart,
...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    body: `Tell us which experience, your date, your villa and your group size — we will reply within the hour with availability and a tailored plan. Hosting something bigger? See <a href="/events" class="text-[#7E6410] hover:underline font-medium">event catering for larger celebrations</a>. Prefer a dinner-only proposal? See our <a href="/proposal-dinner" class="text-[#7E6410] hover:underline font-medium">chef-led proposal dinner</a>.`,
    primaryAction: {
