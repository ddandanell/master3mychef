...
const FAQS = [
  ...
  { question: 'Can we add waiters or a bartender to an experience?', answer: 'Yes — especially cocktail parties and proposal dinners. <a href="/in-villa-service">In-villa service →</a> · <a href="/in-villa-service/bartenders">Bartenders →</a>' },
