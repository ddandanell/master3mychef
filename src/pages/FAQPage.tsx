    ...
    items: [
      {
        ...
        a: 'Message us on WhatsApp at +49 163 5080236 with your date, villa area, guest count and preferred service. We usually respond within 1 hour and confirm availability within 24 hours.',
      },
      {
        ...
        <div className="max-w-[1180px] mx-auto grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-[32px] border border-[#E8E2CF] bg-white p-6 shadow-[0_24px_80px_rgba(0,0,0,0.06)] sm:p-8">
            ...
            <div className="mt-6 rounded-2xl bg-[#1A1A1A] p-5 text-white">
              ...
              <p className="text-sm text-white/[75%] leading-relaxed">WhatsApp +49 163 5080236 and our team will usually reply within 1 hour.</p>
            </div>
          </div>
        </div>
      </section>
