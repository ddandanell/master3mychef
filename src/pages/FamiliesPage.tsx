...
const FAMILIES: FamilyCard[] = [
  {
    ...
    imageWidth: 1440,
    imageHeight: 810,
    imageAlt: 'Candlelit premium dining table set for a six-course fine dining menu in a Bali villa',
  },
  {
    name: 'Three-Course',
    ...
    imageWidth: 1440,
    imageHeight: 810,
    imageAlt: 'Elegantly set table by the pool prepared for a three-course private chef dinner',
  },
  {
    name: 'BBQ Grill',
    ...
    imageWidth: 1440,
    imageHeight: 800,
    imageAlt: 'Satay skewers grilling over glowing coals at a live BBQ station in a Bali villa garden',
  },
  {
    name: "Kids' Menus",
    ...
    imageWidth: 1440,
    imageHeight: 800,
    imageAlt: 'Fresh fruit, pastries and juice served as a floating breakfast in a Bali villa pool',
  },
  {
    ...
    imageWidth: 1408,
    imageHeight: 768,
    imageAlt: 'Candlelit private fine dining table beside a Bali villa pool at dusk',
  },
  {
    ...
    imageWidth: 1440,
    imageHeight: 800,
    imageAlt: 'Private chef plating dishes in a sunlit Bali villa kitchen during event catering',
  },
]
