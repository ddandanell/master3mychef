...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    <p>This is partly driven by the rise of longer villa stays: with a week in Bali rather than a long weekend, breakfast becomes a daily dining experience worth investing in rather than something to rush through before a day of activities. Our <a href="/blog/floating-breakfast-bali" class="text-[#C5A028] hover:underline font-medium">floating breakfast guide</a> covers this in more detail.</p>`,
  },
  {
    id: 'trend-dietary',
    type: 'content',
    ...
    <p>Our <a href="/blog/food-allergies-dietary-requirements-bali" class="text-[#C5A028] hover:underline font-medium">dietary requirements guide</a> explains how we handle this and what to specify when booking.</p>`,
  },
  {
    id: 'trend-wine',
    type: 'content',
