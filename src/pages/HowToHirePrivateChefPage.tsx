...
const SECTIONS = [
  ...
  },
  {
    ...
    <p>myCHEF operates with all of the above as standard: specialist chef team, HACCP certification, same-day replacement guarantee, and money-back assurance. It's the framework we built after seeing too many guests left stranded by informal operators in the years before we launched. For a fuller picture of <a href="/blog/private-chef-roles-responsibilities-explained">what a private chef's role actually covers</a>, read our dedicated guide.</p>`,
  },
  {
    id: 'questions-to-ask',
    type: 'content' as const,
