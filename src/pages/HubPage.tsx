    ...
    <div>
        ...
        <div className="mx-auto max-w-[1280px] px-5 sm:px-6">
          <div className="mb-8 md:mb-12">
            ...
            <div className="mx-auto mb-12 text-center">
              <a
                href="https://wa.me/62089674072020"
                target="_blank"
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col items-center">
            <a
              href="https://wa.me/62089674072020?text=Hi%20myCHEF,%20I%20would%20like%20to%20arrange%20dining%20at%20my%20villa"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="py-24 md:py-32 px-6" style={{ background: 'var(--u-bg)' }}>
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center mt-12">
            <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="homepage-faq-cta" className="inline-flex items-center gap-2 px-8 py-4 text-sm font-semibold tracking-widest uppercase rounded-full transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white" style={{ background: '#C5A028', color: '#1A1A1A' }}>
      ...
      <section className="py-24 md:py-32 px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="homepage-final-cta" className="inline-flex items-center gap-2 px-10 py-5 bg-[#C5A028] text-[#1A1A1A] text-sm font-semibold tracking-widest uppercase rounded-full hover:bg-[#D4B43A] transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white">
