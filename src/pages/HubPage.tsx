...
const FAQS = [
  ...
  { q: 'Do you offer a private cooking class at our Bali villa?', a: 'Yes — a private Indonesian/Balinese class in your villa kitchen (not a tourist school). About 2.5–3 hours, cook 4–6 dishes, eat what you cooked, diploma included. From IDR 700,000++ per person, min 4 (all-in IDR 847,000). <a href="/experiences/cooking-class">Cooking class Bali →</a> · <a href="/experiences/sushi-masterclass">Sushi masterclass →</a>' },
