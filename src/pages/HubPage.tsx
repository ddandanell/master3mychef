...
const FAQS = [
  ...
  { q: 'Do you offer a private cooking class at our Bali villa?', a: 'Yes — a 3-hour private Indonesian class in your villa kitchen (not a tourist school). Eat what you cook; diploma included. From IDR 700,000++ per person, min 4. <a href="/experiences/cooking-class">Cooking class Bali →</a> · <a href="/experiences/sushi-masterclass">Sushi masterclass →</a>' },
