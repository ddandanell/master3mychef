    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <SeoHead
        ...
        jsonLd={[
          ...
          faqPageSchema([...FAQS, ...CITY_CONTENT['jakarta'].faqs].map(f => ({ question: f.q, answer: f.a }))),
          {
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[...FAQS, ...CITY_CONTENT['jakarta'].faqs].map((faq, i) => (
      ...
      <section className="py-16 bg-[#F5F3F0] border-t border-[#E8E6E3]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <CityDeepDive slug="jakarta" cityName="Jakarta" />
</div>
  )
}
