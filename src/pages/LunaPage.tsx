      ...
      */}
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto">
          ...
          <div className="text-center">
            ...
            <Button asChild variant="secondary" size="brand" className="text-sm tracking-[0.2em] hover:shadow-[0_0_40px_-10px_rgba(212,175,55,0.2)]">
              <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="luna-howitworks-cta">
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center mt-12">
            <Button asChild variant="whatsapp" size="brand">
              <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="luna-included-cta">
      ...
      <section id="faq" className="py-24 md:py-32 px-6 scroll-mt-24">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <Button asChild variant="whatsapp" size="brand">
              <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="luna-faq-cta">
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
            <div>
              ...
              <Button asChild variant="whatsapp" size="brand">
                <a href="https://wa.me/62089674072020?text=Hi%20myCHEF%2C%20I%27d%20like%20to%20book%20a%20fine%20dining%20experience." target="_blank" rel="noopener noreferrer" data-source="luna-fine-dining-cta">
                  <Phone className="w-4 h-4" />
      ...
      <section id="final-cta" className="py-20 md:py-24 px-6" style={{ background: '#0A0A0A' }}>
        <div className="max-w-[1000px] mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button asChild variant="whatsapp" size="brand">
              <a href="https://wa.me/62089674072020?text=Hi%20myCHEF%2C%20I%27d%20like%20to%20reserve%20a%20fine%20dining%20evening%20in%20Bali." target="_blank" rel="noopener noreferrer" data-source="luna-final-cta">
                <Phone className="w-4 h-4" />
