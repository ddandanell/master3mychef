...
const FAQS = [
  ...
  { question: 'What is the difference between fine dining and a daily private chef?', answer: 'Fine dining is a multi-course event with a brigade, presentation and ingredients in the per-person price. A <a href="/private-chef-bali">daily private chef</a> is a full day of staff at IDR 2,700,000++/day with groceries at cost — three flexible meals for a stay, not a tasting show. One meal is catering.' },
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <p className="text-white/[70%] mb-6 leading-relaxed">
                Every ingredient is sourced that morning. The pasta is rolled in your kitchen. The Wagyu is flame-grilled in front of your guests. The wine is paired course by course. And when the evening ends, the team leaves your villa spotless — as if they were never there. Read our <Link to="/blog/seasonal-ingredients-bali-cooking-guide" className="text-[#C5A028] hover:underline focus:outline-none focus:ring-2 focus:ring-[#C5A028] rounded px-0.5">seasonal ingredients Bali cooking guide</Link> to understand what drives those morning market choices. Travelling beyond Bali? The same team runs <Link to="/private-dining-indonesia" className="text-[#C5A028] hover:underline focus:outline-none focus:ring-2 focus:ring-[#C5A028] rounded px-0.5">private dining</Link> across Indonesia.
              </p>
