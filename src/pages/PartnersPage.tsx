          ...
          <div>
            ...
            <div className="rounded-[24px] border border-[#E8E3D8] bg-white overflow-hidden">
              ...
              <div className="px-6 py-4 bg-[#FAFAF8] border-t border-[#E8E3D8] text-xs text-[#6B6560]">
                Commissions tracked per booking and paid monthly. WhatsApp <a href={partnerWhatsapp} className="text-[#C5A028] underline underline-offset-2">+62089674072020</a> to discuss which tier fits your property.
              </div>
            </div>
          </div>
        </div>
