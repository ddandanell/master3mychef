    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg text-[#4A4745] max-w-none">
            <p className="mb-0 leading-relaxed">
              Pererenan's signature product isn't a single dinner — it's the month. A weekly arrangement gives you the same Indonesian chef across your stay: learning the household's preferences, managing the shopping and the fridge, building menus that evolve rather than repeat. Many of our Pererenan clients book this way, and it's the service the area's villas were quietly built for. For format detail, see our <Link to="/villa-chef" className="text-[#C5A028] hover:underline font-medium">daily villa chef service</Link> and <Link to="/hire-private-chef-bali-monthly" className="text-[#C5A028] hover:underline font-medium">monthly chef arrangements</Link>; for coverage further south, our team also runs <Link to="/private-chef/canggu" className="text-[#C5A028] hover:underline font-medium">private chef services across Canggu</Link>.
            </p>
          </div>
        </div>
      </section>
