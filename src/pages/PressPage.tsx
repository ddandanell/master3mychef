    ...
    <main className="min-h-screen bg-[#F5F3EE] text-[#1A1916]">
      <SeoHead
        ...
        jsonLd={[aggregateRatingSchema(4.9, 560), breadcrumbSchema('Press & Media', `${SITE}/press`), faqPageSchema([
          { question: 'How do I request a press kit for myCHEF.id?', answer: 'Press kits, high-resolution imagery, and interview requests can be arranged via WhatsApp at +62 896-7407-2020 or email indonesia@mychef.id. We respond within 24 hours.' },
