...
export default function PricingCalculatorPage() {
  ...
  const buildWhatsAppUrl = () => {
    ...
    return `https://wa.me/628113803488?text=${encodeURIComponent(message)}`
  }
  ...
  return (
    <>
      <SeoHead
        ...
        description="Get an instant private chef cost estimate for your Bali villa. Select service type, guest count, and menu level — see your price in seconds. From IDR 350K/person."
              ...
              <div>
                ...
                {selectedGuestIsContactOnly && (
                  <div className="mt-5 p-4 bg-amber-50 border border-amber-200 rounded-xl text-center">
                    ...
                    <a
                      href="https://wa.me/628113803488?text=Hi%20myCHEF%2C%20I%20need%20catering%20for%2080%2B%20guests.%20Can%20you%20send%20a%20custom%20quote%3F"
                      target="_blank"
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-12 text-center bg-stone-50 rounded-2xl p-8">
            ...
            <a
              href="https://wa.me/628113803488?text=Hi%20myCHEF%2C%20I%20would%20like%20to%20enquire%20about%20booking%20a%20private%20chef%20in%20Bali."
              target="_blank"
              rel="noopener noreferrer"
