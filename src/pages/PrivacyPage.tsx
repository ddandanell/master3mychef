...
const FAQS = [
  ...
  },
  {
    ...
    a: 'You can request deletion of your personal information by contacting us at indonesia@mychef.id or via WhatsApp at +62089674072020. We will process your request subject to any legal retention requirements.',
  },
  {
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="mt-16 p-8 rounded-2xl border border-white/10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="https://wa.me/62089674072020" target="_blank" rel="noopener noreferrer" data-source="privacy-cta" className="inline-flex items-center gap-2 px-6 py-3 bg-[#C5A028] text-[#1A1A1A] text-sm rounded-full hover:bg-[#D4B43A] transition-all focus:outline-none focus:ring-2 focus:ring-white rounded px-0.5">
