...
const SECTIONS = [
  ...
  },
  {
    ...
    <p><strong>Part-Time Meal Prep (monthly rate — IDR 800,000++ per day on session days):</strong> Your chef and assistant come three times per week for a one-meal batch cooking session, preparing portioned, refrigerator-ready meals for the week ahead. The one-meal plan (standard IDR 1,000,000++ per day; 20% off at the monthly rate) suits solo travelers or digital nomads who eat out frequently but want healthy home-cooked backup, or couples who cook some meals themselves but want a mid-week reset. Lower cost, lighter commitment, still meaningful impact on diet quality and time.</p>
  ...
  },
  {
    ...
    <p><strong>Home-cooked meals with a private chef:</strong> A three-meals-a-day arrangement — breakfast, lunch and dinner cooked and served by one professional chef with a dedicated assistant — is IDR 2,160,000++ per day at the monthly rate (20% off the standard IDR 2,700,000++), roughly IDR 100M++ per month for daily service. Groceries are charged separately at cost, supported by receipts; a couple eating well typically budgets IDR 1M–2M per week. A lighter one-meal plan at the monthly rate (IDR 800,000++ per day) covers one cooked and served meal. This is a premium service rather than a budget hack — the return shows up in the health and time dividends below, not in a headline saving versus restaurants. Prices are subject to a 10% service charge and 11% tax.</p>
