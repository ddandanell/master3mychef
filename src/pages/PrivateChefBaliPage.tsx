...
const FAQS = [
  ...
  { q: 'How much is a private chef in Bali per day?', a: 'Stay chef is a full day of staff: IDR 2,700,000++/day (IDR 3,267,000 all-in) for chef + assistant, about 10 guests. Three meals — assign each as breakfast, lunch or dinner. Weekly −10%, monthly −20% on that full-day rate only. One meal is catering. <a href="/private-chef-bali">Private chef Bali</a>.' },
