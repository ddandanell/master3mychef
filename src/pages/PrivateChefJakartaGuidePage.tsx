...
const SECTIONS = [
  ...
  },
  {
    ...
    SCBD is Jakarta's financial and corporate nerve centre. Private chef demand here is primarily corporate: executive household dinners in serviced residences, client entertainment for senior deal teams, and boardroom lunches in private apartments or office suites. The buildings are luxurious, the kitchens can be compact, and the clients are pressed for time. This is the area where our <a href="/blog/corporate-events-catering-bali-team-dining" class="text-[#7E6410] hover:underline font-medium">corporate catering</a> expertise translates most directly — efficient, professional, executive-grade service in a compressed format.</p>
    ...
    features: [
      {
        ...
        desc: 'Intimate plated dinners from 2 guests to seated occasions of 30+. Whether it is a couples tasting menu in Pondok Indah or a formal dinner party for 20 in Menteng, we design and execute the menu end-to-end. See our full <a href="/fine-dining/private-chef-bali" class="text-[#7E6410] hover:underline font-medium">private dining approach</a>.',
      },
      {
        icon: Briefcase,
        title: 'Corporate & Executive',
        desc: 'Boardroom lunches, client entertainment in serviced residences, and executive household dining. Designed for SCBD and Sudirman clients where discretion, punctuality, and presentation quality are non-negotiable. Aligned with our <a href="/blog/corporate-events-catering-bali-team-dining" class="text-[#7E6410] hover:underline font-medium">corporate catering standards</a>.',
      },
      {
        icon: Users,
  ...
  },
  {
    ...
    <p><strong>Private dinner (per occasion):</strong> IDR 700,000–900,000 per person, depending on menu tier. A casual 3-course dinner for 4–6 guests in a South Jakarta home sits at the lower end. A 6-course tasting menu with imported protein (wagyu, langoustine, truffle elements) for a corporate client entertainment dinner sits at the upper end. The per-person price includes chef fee, ingredients, setup, and service.</p>

    <p><strong>Corporate lunch (per person):</strong> From IDR 700,000 per person for a 2–3 course working lunch or boardroom meal. Designed for 6–20 guests. Efficient format, professional presentation, dietary accommodations included.</p>
    ...
    <p>All pricing is confirmed after an initial WhatsApp consultation where we understand your specific requirements. Final quotes are fixed — no hidden additions on the day of service. See our full <a href="/pricing" class="text-[#7E6410] hover:underline font-medium">pricing guide</a> for base rate reference.</p>`,
  },
  {
    id: 'vs-bali',
    type: 'content' as const,
  ...
  },
  {
    ...
    primaryAction: {
      ...
      href: 'https://wa.me/6289674072020?text=Hi%20myCHEF%2C%20I%27m%20in%20Jakarta%20and%20looking%20for%20a%20private%20chef.',
    },
