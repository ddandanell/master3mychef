...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    <p><strong>Villa parties and corporate groups (10–20):</strong> Buffet, family-style, or plated service for larger gatherings. Staffing can be extended to include <a href="/in-villa-service/waiters" class="text-[#C5A028] hover:underline font-medium">professional waiters</a>, <a href="/in-villa-service/bartenders" class="text-[#C5A028] hover:underline font-medium">bartenders</a>, and a <a href="/in-villa-service/sommelier" class="text-[#C5A028] hover:underline font-medium">sommelier</a> for a fully staffed event.</p>
