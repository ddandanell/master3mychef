...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    <p style="margin-top:0.75rem;">For our full service overview see the <a href="/how-it-works" class="text-[#C5A028] hover:underline font-medium">how it works page</a>.</p>`,
  },
  {
    id: 'cta',
    type: 'cta',
