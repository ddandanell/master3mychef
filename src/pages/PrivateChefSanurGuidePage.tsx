  ...
  return (
    <PremiumPage
      ...
      relatedPages={[
        ...
        { label: 'Expat Private Chef Guide', href: '/hire-private-chef-bali-monthly', desc: 'Regular private chef service for Bali expats and long-stay residents.' },
