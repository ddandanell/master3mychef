...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    <p><strong>Retirement anniversary and milestone dinners:</strong> Sanur's calmer character makes it popular for milestone occasions — significant wedding anniversaries, retirement celebrations, landmark birthdays — where the goal is quality and intimacy rather than spectacle. A private chef dinner at a Sanur villa for 6-10 people is a common format for these occasions. See our <a href="/blog/anniversary-dinner-villa-bali" class="text-[#7E6410] hover:underline font-medium">anniversary dinner guide</a>.</p>
    <p><strong>Expat household regular meals:</strong> Sanur's established expat community creates demand for ongoing regular chef services — not a one-off dinner but a weekly cooking arrangement. A chef who visits twice a week to prepare lunches and batch-cook for the household. This is more common in Sanur than anywhere else in Bali. See our <a href="/blog/household-chef-bali-hiring-guide" class="text-[#7E6410] hover:underline font-medium">household chef guide</a>.</p>
