...
const FAQS = [
  { q: 'How much is a private chef in Bali per day?', a: 'Stay chef is a full day of staff at IDR 2,700,000++ (IDR 3,267,000 all-in). Three flexible meals. One meal is catering. <a href="/private-chef-bali">Private chef Bali</a>.' },
    ...
    <div className="bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <section className="mb-12">
          ...
          <p className="text-base leading-relaxed text-[#444] mb-4">
            Private chef booking through myCHEF operates on a 24–48 hour lead time for most dates and group sizes. You message us on WhatsApp with your date, villa, guest count, and preferences. We respond with a menu proposal within two hours. You review, adjust, approve, and the chef arrives at your villa with everything needed. No reservation management, no confirmation chase, no group transfer coordination. For a full walkthrough, see <Link to="/blog/private-chef-bali-preparation-12-guest-villa-dinner" className="text-[#C5A028] hover:underline font-medium">how a 12-guest villa dinner actually runs</Link>.
          </p>
          <p className="text-base leading-relaxed text-[#444]">
