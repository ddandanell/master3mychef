...
const SECTIONS: PageSection[] = [
  ...
  },
  {
    ...
    <p>We work across all of Bali's villa regions — if your villa is not listed here, <a href="https://wa.me/4915234561712" class="text-[#C5A028] hover:underline font-medium">message us on WhatsApp</a> and we will confirm availability at your specific location.</p>`,
  },
  {
    id: 'pricing',
    type: 'content' as const,
    ...
    <p>Floral décor packages, rose petal arrangements, and photographer coordination are available as add-ons. For full pricing across all tiers, see our <a href="/pricing" class="text-[#C5A028] hover:underline font-medium">pricing page</a>. To discuss a bespoke package for your specific vision, <a href="https://wa.me/4915234561712" class="text-[#C5A028] hover:underline font-medium">message us directly on WhatsApp</a> — we respond within the hour.</p>`,
  },
  {
    id: 'faq',
    type: 'faq' as const,
  ...
  },
  {
    ...
    primaryAction: {
      ...
      href: 'https://wa.me/4915234561712?text=Hi%20myCHEF%2C%20I%27m%20planning%20a%20proposal%20dinner%20in%20Bali%20and%20would%20love%20to%20discuss%20options.',
      external: true,
    },
    secondaryAction: {
      label: 'View Pricing',
