...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'Tell us your retreat dates, guest count, and dietary philosophy. We will design a custom catering proposal within 24 hours. <a href="/quote" class="text-[#C5A028] hover:underline font-medium">Get a free quote</a> to get started.',
  },
]
...
const FAQS = [
  ...
  { question: 'What is the pricing for retreat catering?', answer: 'From IDR 350,000 per person per day for full-board packages. See our <a href="/pricing" class="text-[#C5A028] hover:underline font-medium">full pricing page</a> for details. Pricing varies based on menu complexity, dietary requirements, and staffing needs. We provide detailed quotes within 24 hours.' },
]
