    ...
    <div ref={ref} className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <SeoHead
        ...
        jsonLd={[
          ...
          serviceSchema(
            ...
            'Professional hosts and hostesses for villa events, weddings, and corporate functions in Bali. Welcome service, guest direction, and event coordination.',
            `${SITE}/in-villa-service/host-hostess`,
            'IDR',
          ),
          faqPageSchema(FAQS.map(f => ({ question: f.q, answer: f.a }))),
          aggregateRatingSchema(4.9, 78),
          breadcrumbSchema('Host & Hostess', `${SITE}/in-villa-service/host-hostess`, 'In-Villa Service', `${SITE}/in-villa-service`),
        ]}
      />
      ...
      <section className="relative min-h-[85vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img src="/generated/trust-hosts.webp" alt="Professional hosts welcoming guests at Bali villa event" className="w-full h-full object-cover" width={1920} height={1080} fetchPriority="high" />
      ...
      <section id="book" className="relative py-24 md:py-32 px-6 overflow-hidden">
        <div className="absolute inset-0">
          <img src="/generated/staffing-hero.webp" alt="Professional hosts at Bali villa event" className="w-full h-full object-cover" loading="lazy" />
