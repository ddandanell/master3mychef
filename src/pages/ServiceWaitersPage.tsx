    ...
    <div ref={ref} className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="/generated/mychef-service-bali-hero-waiters.webp"
        srcSet={getHeroSrcSet('/generated/mychef-service-bali-hero-waiters.webp')}
        sizes="100vw" alt="Villa waiters Bali serving a plated course at an elegant private villa dinner" className="w-full h-full object-cover" width={1920} height={1080} decoding="async" fetchPriority="high" loading="eager" />
          <div
      ...
      <section id="book" className="relative py-24 md:py-32 px-6 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href={WA_LINK} target="_blank" rel="noopener noreferrer" data-source="service-waiters-cta" className="inline-flex items-center gap-2 px-8 py-4 bg-[#C5A028] text-[#1A1A1A] text-sm font-semibold tracking-widest uppercase rounded-full hover:bg-[#D4B43A] transition-all focus:outline-none focus:ring-2 focus:ring-white">
