  ...
  return (
    <div ref={ref} data-universe="sol" className="min-h-screen" style={{ background: '#F5F0E8', color: '#2C2419' }}>
      <SeoHead
        ...
        jsonLd={[localBusinessSchema, serviceSchema('Villa Chef Bali', getPageMeta('villa-chef').description, getPageMeta('villa-chef').canonical), aggregateRatingSchema(4.9, 320), breadcrumbSchema('Villa Chef', getPageMeta('villa-chef').canonical), faqPageSchema(FAQS.map(f => ({ question: f.q, answer: f.a })))]}
      />
      {/* Hero */}
      ...
      <section id="how-it-works" className="sol-content py-24 md:py-32 px-6 scroll-mt-24">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="text-center">
            <a href="https://wa.me/491635080236" target="_blank" rel="noopener noreferrer" data-source="sol-howitworks" className="inline-flex items-center gap-2 px-8 py-4 bg-[#C5A028] text-white text-sm font-semibold tracking-widest uppercase rounded-full hover:bg-[#D4B43A] transition-all focus:outline-none focus:ring-2 focus:ring-white rounded px-0.5">
      ...
      <section className="py-24 md:py-32 px-6" style={{ background: '#F5F0E8' }}>
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center mt-12">
            <a href="https://wa.me/491635080236" target="_blank" rel="noopener noreferrer" data-source="sol-testimonials" className="inline-flex items-center gap-2 px-8 py-4 bg-[#C5A028] text-white text-sm font-semibold tracking-widest uppercase rounded-full hover:bg-[#D4B43A] transition-all focus:outline-none focus:ring-2 focus:ring-white rounded px-0.5">
