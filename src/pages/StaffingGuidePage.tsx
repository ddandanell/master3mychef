...
const STAFFING_ROLES = [
  {
    ...
    priceEstimate: 'IDR 400K–600K per person per evening',
  },
  {
    role: 'Bartenders',
    ...
    priceEstimate: 'IDR 500K–700K per person per evening',
  },
  {
    role: 'Sommeliers',
    ...
    priceEstimate: 'IDR 600K–1M per person per evening',
  },
  {
    role: 'Butler Service',
  ...
  },
  {
    ...
    priceEstimate: 'IDR 1.2M–2M per day',
  },
  {
    ...
    priceEstimate: 'IDR 300K–500K per person per day',
  },
]
    ...
    <div className="bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <section className="bg-[#1A1A1A] text-white py-16">
        <div className="max-w-3xl mx-auto text-center px-6">
          ...
          <a
            href="https://wa.me/62089674072020?text=I%20need%20professional%20staff%20for%20my%20villa%20event..."
