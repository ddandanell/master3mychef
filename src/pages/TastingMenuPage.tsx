...
const WA_LINK = `https://wa.me/${WA}?text=Hi%20myCHEF%2C%20I%27d%20like%20to%20book%20a%20private%20tasting%20menu%20in%20my%20Bali%20villa.`
...
export default function TastingMenuPage() {
  ...
  return (
    <div ref={ref} className="min-h-screen" style={{ background: '#FAFAF8', color: '#1A1A1A' }}>
      ...
      <Breadcrumb items={[{ label: 'Fine Dining', href: '/fine-dining' }, { label: 'Tasting Menu' }]} />
      ...
      <section className="py-24 px-6 bg-[#FAFAF8]">
        <div className="max-w-[1080px] mx-auto">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl" style={{ fontFamily: "'Playfair Display', serif" }}>4.9 ★ — 560+ Villa Dinners</h2>
          </div>
