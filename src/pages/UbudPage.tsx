    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        ...
        <ul className="space-y-2 text-[#4A4745]">
          ...
          <li><Link to="/experiences/cooking-class#ubud" className="text-[#C5A028] hover:underline font-medium">Cooking class in Ubud</Link> — private Balinese cooking class in your villa kitchen; chef comes to you.</li>
