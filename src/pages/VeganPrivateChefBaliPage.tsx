...
This approach works well for groups of 6--30 where dietary requirements are genuinely varied. We coordinate the menu design at the time of booking.`,
  },
  {
    ...
    body: `**Villa Holiday Chef** -- Daily meals for a vegan household or group on a villa holiday. Breakfast, lunch, and dinner cooked fresh every day. No restaurants, no guesswork, no hidden animal products. Full-day stay chef at IDR 2,700,000++/day (IDR 3,267,000 all-in) — three flexible meals, one chef and one dedicated assistant included, groceries at cost with receipts. One meal is catering. Weekly rate 10% off, monthly rate 20% off. Prices are subject to a 10% service charge and 11% tax.
...
const faqs = [
  { question: 'How much is a private chef in Bali per day?', answer: 'Stay chef is a full day of staff: IDR 2,700,000++/day (IDR 3,267,000 all-in) for chef + assistant, about 10 guests. Three meals — assign each as breakfast, lunch or dinner. Weekly −10%, monthly −20% on that full-day rate only. One meal is catering. <a href="/private-chef-bali">Private chef Bali</a>.' },
