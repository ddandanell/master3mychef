...
const SECTIONS = [
  {
    ...
    <p>With a private chef handling catering, the birthday person enjoys the party instead of worrying about food. A professional team manages every course, dietary need, and service detail — leaving you free to celebrate. Browse our <a href="/events" class="text-[#7E6410] hover:underline font-medium">private events and parties service</a> or explore <a href="/catering" class="text-[#7E6410] hover:underline font-medium">villa catering options</a> to get started.</p>`,
  },
  {
    id: 'party-sizes',
  ...
  },
  {
    ...
    body: `<p><strong>Tropical Bali Feast:</strong> The classic villa birthday. Babi guling (slow-roasted suckling pig) as centerpiece, sate lilit, lawar salad, rice, and sambal. Adds cultural authenticity and spectacle. Guests eat together in communal style — festive and social. Especially popular at <a href="/locations/seminyak" class="text-[#7E6410] hover:underline font-medium">Seminyak villas</a> and <a href="/locations/canggu" class="text-[#7E6410] hover:underline font-medium">Canggu surf villas</a>.</p>
    ...
    <p><strong>Grazing & Cocktail:</strong> Charcuterie boards, cheese, dips, crudités, sliders, dessert bites — laid out for guests to graze over 3–4 hours. Flexible and interactive. Pairs well with a cocktail hour format. Our full <a href="/catering" class="text-[#7E6410] hover:underline font-medium">event catering service</a> covers all these styles.</p>
