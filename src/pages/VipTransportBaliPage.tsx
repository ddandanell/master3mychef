        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="rounded-2xl overflow-hidden aspect-[4/3]">
              <img src="/generated/mychef-city-jimbaran.webp" alt="Guests arriving for a sunset dinner overlooking Jimbaran Bay, Bali" width={1536} height={1024} loading="lazy" decoding="async" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
