...
const SECTIONS = [
  {
    ...
    <p>Unlike hotel packages with rigid menus, a private chef adapts your catering to your vision. Balinese-inspired courses for the rehearsal dinner, a Mediterranean spread for the welcome lunch, a formal <a href="/fine-dining" class="text-[#C5A028] hover:underline font-medium">fine dining reception</a> — all possible in your villa kitchen, on your timeline. For full pricing guidance, see our <a href="/pricing" class="text-[#C5A028] hover:underline font-medium">private chef pricing guide</a>.</p>`,
  },
  {
    id: 'event-types',
